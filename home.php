...
<html>
    ...
    <head>
        ...
        <title>Zalando - <?php echo $userinfo['nome']." ".$userinfo['cognome'] ?></title>
    </head>
    <body>
        <div id = 'background'>
            ...
            <section id = 'container_intern_body'>
                <section id = 'intern_body'>
                    ...
                    <article id = 'main_section'>
                        <section id = 'main'>
                            <section id = 'lato_opzioni'>
                                <div class = 'sez_opzioni'>
                                    <h3>Il tuo account</h3>
                                    <a class = 'op'><h5>Panoramica</h5></a>
                                    <a class = 'op'><span>Ordini</span></a>
                                    <a class = 'op'><span>Programmi fedeltà</span></a>
                                    <a class = 'op'><span>Zalando Plus</span></a>
                                    <a class = 'op'><span>Effettua un reso</span></a>
                                    <a class = 'op'><span>Resi</span></a>
                                    <a class = 'op'><span>Dati personali</span></a>
                                    <a class = 'op'><span>Indirizzi</span></a>
                                    <a class = 'op'><span>Buoni regalo</span></a>
                                    <a class = 'op'><span>Newsletter</span></a>
                                </div>
                                <div class = 'sez_opzioni'>
                                    <h3>I tuoi articoli</h3>
                                    <a class = 'op'><span>Abbigliamento</span></a>
                                    <a class = 'op'><span>Beauty</span></a>
                                </div>
                                <div class = 'sez_opzioni'>
                                    <h3>Personalizza</h3>
                                    <a class = 'op'><span>Le tue taglie</span></a>
                                    <a class = 'op'><span>Le mie preferenze</span></a>
                                    <a class = 'op'><span>I miei creator</span></a>
                                </div>
                                <div class = 'sez_opzioni'>
                                    <h3>Altro</h3>
                                    <a class = 'op'><span>Aiuto e contatti</span></a>
                                </div>
                                <div class = 'sez_opzioni'>
                                    <h3>Dati e privacy</h3>
                                    <a class = 'op'><span>Preferenze per i consigli</span></a>
                                    <a class = 'op'><span>Richiedi o cancella i dati</span></a>
                                </div>
                            </section>
                            <section id = 'parte_centrale'>
                                <img src = ".\immagini\main_section_icons\9a.png">
                                <h1>Il tuo account</h1>
                                <span>Dal tuo account Zalando puoi gestire i tuoi ordini, resi e dati di contatto.</span>
                                <section>
                                    <div id = 'shopper' class="material-symbols-outlined">shopping_bag</div>
                                    <h5>Tutto sotto controllo :&#41</h5>
                                    <span>Trovi qui le info sui tuoi aggiornamenti, resi o rimborsi.</span>
                                    <a><span>Continua lo shopping</span></a>
                                </section>
                            </section>
                        </section>
                    </article>
                    <article id = 'logout'><span>Non sei<?php echo " ".$userinfo['nome']?>? <a href = 'logout.php'>Disconnetti</a></article>
                    <article id = 'preferenze'></article>
